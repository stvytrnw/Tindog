  ...
  if (!isWaiting) {
    ...
    if (!allDogsSwiped) {
      dog.hasBeenLiked == true
        ? (document.getElementById(
            "rateLogo"
          ).innerHTML = `<img src="images/badge-like.png" alt="like badge" class="likeBadge">`)
        : (document.getElementById(
            "rateLogo"
          ).innerHTML = `<img src="images/badge-nope.png" alt="dislike badge" class="dislikeBadge">`);
    }
    ...
    dogArray.length !== 0
      ...
      : setTimeout(() => {
          document.getElementById(
            "dog"
          ).innerHTML = `<p class="endMessage">You swiped all the dogs!</p>`;
          allDogsSwiped = true;
        }, 1500);
  }
}
...
document
  ...
  .addEventListener("click", () => setRatingBadge());
